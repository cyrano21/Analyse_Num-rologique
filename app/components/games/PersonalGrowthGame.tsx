...
interface PersonalGrowthGameProps {
  formData: any;
  gameStates: any;
...
const PersonalGrowthGame: React.FC<PersonalGrowthGameProps> = memo(
  ({
    formData,
    gameStates,
    setGameStates,
...
export default PersonalGrowthGame;
